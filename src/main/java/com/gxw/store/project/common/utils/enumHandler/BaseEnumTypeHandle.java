...
@MappedTypes(value = {BusinessScale.class, BusinessStatus.class, StaffStatus.class, AdminStatus.class, ExpressType.class, OrderStatus.class, Mode.class, CouponUseStatus.class})
