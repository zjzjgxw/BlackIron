...
public class RedisCache
{
     ...
     * @return
     */
    public  ValueOperations<String, Long> incrementCacheObject(String key, Long value)
    {
     ...
     * @return
     */
    public  ValueOperations<String, Long> incrementCacheObject(String key, Long value,Long expire)
    {
        ValueOperations<String, Long> operation = redisTemplate.opsForValue();
        operation.increment(key, value);
        redisTemplate.expire(key,expire,TimeUnit.SECONDS);
